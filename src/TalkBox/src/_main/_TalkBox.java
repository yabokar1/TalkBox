...
public class _TalkBox extends Application {
	...
	public void AddProfileBox(RootView root, ButtonPanel panel) {
		...
		section2.getChildren().addAll(new Label("Profiles"),this.Profiles().getTreeItem(),this.enterProfileTextField(),new Label("Audio"),this.AudioSample(panel).getList(),addRecordArea());
